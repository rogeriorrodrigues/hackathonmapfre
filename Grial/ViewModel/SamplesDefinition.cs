		...
		internal static void InitializeSamples()
		{
			...
			categories.Add(
				...
				new SampleCategory
				{
					...
					SamplesList = new List<Sample> {
						new Sample("Pontos", typeof(PontosPage), SampleData.DashboardImagesList[6], '\uf0d0'),
					new Sample("Premios", typeof(PremiosPage), SampleData.DashboardImagesList[6], '\uf06b'),
						new Sample("Checkin", typeof(SocialVariantPage), SampleData.DashboardImagesList[6], '\uf046'),
					}
				}
			);
			...
			categories.Add(
				...
				new SampleCategory
				{
					...
					Icon = '\uf003',
					SamplesList = new List<Sample> {
						new Sample("Pânico", typeof(PanicoPage), SampleData.DashboardImagesList[8], '\uf085'),
					new Sample("Alertar", typeof(CheckinInsertPage), SampleData.DashboardImagesList[8], '\uf128'),
					}
				}
			);
			...
			categories.Add(
				...
				new SampleCategory
				{
					...
					Icon = '\uf023',
					SamplesList = new List<Sample> {
						new Sample("Entrar", typeof(LoginPage), SampleData.DashboardImagesList[5], '\uf023', true),
					new Sample("Meu Perfil", typeof(MeuPerfilPage), SampleData.DashboardImagesList[5], '\uf007', true),
